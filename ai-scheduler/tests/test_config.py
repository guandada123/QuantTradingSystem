...
class TestSettingsDefaults:
    ...
    def clean_env(self, monkeypatch):
        ...
        env_vars = [
            "SERVICE_NAME", "SERVICE_HOST", "SERVICE_PORT", "DEBUG",
            "DATABASE_URL", "REDIS_URL",
            "DEEPSEEK_API_KEY", "DEEPSEEK_BASE_URL", "DEEPSEEK_MODEL",
            "STRATEGY_SERVICE_URL", "EXECUTION_SERVICE_URL",
            "FEISHU_WEBHOOK", "HEALTH_CHECK_INTERVAL",
            "SCAN_INTERVAL_MINUTES", "MAX_CANDIDATES", "AI_TIMEOUT_SECONDS",
        ]
        for v in env_vars:
...
class TestOptionalFields:
    ...
    def clean_env(self, monkeypatch):
        env_vars = [
            "DEEPSEEK_API_KEY", "FEISHU_WEBHOOK",
            "SERVICE_NAME", "SERVICE_HOST", "SERVICE_PORT", "DEBUG",
            "DATABASE_URL", "REDIS_URL",
            "DEEPSEEK_BASE_URL", "DEEPSEEK_MODEL",
            "STRATEGY_SERVICE_URL", "EXECUTION_SERVICE_URL",
            "HEALTH_CHECK_INTERVAL", "SCAN_INTERVAL_MINUTES",
            "MAX_CANDIDATES", "AI_TIMEOUT_SECONDS",
        ]
        for v in env_vars:
            monkeypatch.delenv(v, raising=False)
