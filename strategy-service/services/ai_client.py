...
class AIClient:
    ...
    async def call(
        ...
        try:
            ...
            if provider in (ModelProvider.DEEPSEEK, ModelProvider.KIMI, ModelProvider.GLM):
            ...
            logger.info(
                f"AI调用成功: {provider.value}/{model_name}, {input_tokens}+{output_tokens}tokens, ${cost:.4f}, {latency_ms}ms"
            )
