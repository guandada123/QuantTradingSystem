...
source_online = Gauge(
    'data_source_online',
    'Data source online status (1=online)',
    ['source_name']
)
...
class DataQualityMonitor:
    ...
    async def check_anomalies(self, source: str, values: List[float], threshold: float = 3.0) -> int:
        """检查异常值（Z-score 方法）"""
        if len(values) < 10:
            return 0
